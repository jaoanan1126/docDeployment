...
<Note>
## Interactive Relationship Discovery
...
![Example of relationship indicators in API documentation](https://docs.ramp.com/assets/entity_relationships_example-BbzSRvYM.png)

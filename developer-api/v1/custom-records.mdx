...
To get started, use the [Custom Records Configuration](/api-reference/custom-records/extend-native-ramp-table) API to set up tables and columns.
Then, use the [Native Tables](/api-reference/custom-records/list-native-ramp-tables) and [Custom Tables](/api-reference/custom-records/list-custom-tables) API to manage and manipulate data.
...
![Custom records example schema diagram](https://docs.ramp.com/assets/custom-records-example-mermaid-CapLE1vY.png)
...
[Users endpoint](/api-reference/user/list-users)
...
[Locations endpoint](/api-reference/location/list-locations)
...
[Departments endpoint](/api-reference/department/list-departments)
...
[Accounting Field Options endpoint](/api-reference/accounting/list-options-for-a-given-custom-accounting-field)
...
[Entities Endpoint](/api-reference/business-entities/list-business-entities)
...
[Bills endpoint](/api-reference/bill/list-bills)
...
[Transactions endpoint](/api-reference/transaction/list-transactions)
...
[Reimbursements endpoint](/api-reference/reimbursement/list-reimbursements)